...
public class ObRestDatajpaApplication {
	...
	public static void main(String[] args) {
		...
		//crear un libro
		Book book = new Book(null, "El señor de los anillos", "J.R.R Tolkien", 1200, 1200.0, null);
		Book book2 = new Book(null, "El señor de los anillos", "J.R.R Tolkien", 1200, 1200.0, null);
